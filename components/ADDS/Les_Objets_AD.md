...
1. [Les OU](#1-Les-ou)
   ...
   - [1.3 Création des sous-OU](#13-création-des-sous-ou)
      - [1.3.1 Sous-OU Utilisateurs](#132-sous-ou-de-billuusers)
...
2. [Création des utilisateurs](#2-création-des-utilisateurs)
   ...
   - [2.5 Désactivation et archivage des utilisateurs](#25-Désactivation-et-archivage-des-utilisateurs)
...
3. [Déplacement automatique des ordinateurs](#3.déplacement-automatique-des-ordinateurs)
...
6. [Tâche planifiée](#6-tâche-planifiée)

8. [Jonction au domaine](#7-jonction-au-domaine)

9. [Partage des rôles FSMO (PDC et RID)](#8-transfert-des-rôles-fsmo-pdc-et-rid)
...
10. [Relation de confiance avec PharmGreen](#9-relation-de-confiance-avec-PharmGreen)
