...
```
C:\Logs\
├── Script1-CreationComptes.log
├── Script2-CreationDossiers.log
├── Script3-MappageLecteurs.log
├── Script4-<NomDuScript>.log
```
...
```powershell
$LogFile = "C:\Logs\Script2-CreationDossiers.log"
...
2026-06-16 09:42:14 [ERROR] Échec création dossier pour mlefevre : Accès refusé
```
...
| - | ------------------------------------ | ----------------------------------------- | -------------------------------------------------------- |
| 1 | Création des comptes AD              | `C:\Logs\Script1-CreationComptes.log`     | Création des 218 comptes utilisateurs dans l'AD          |
| 2 | Création des 218 dossiers individuels | `C:\Logs\Script2-CreationDossiers.log`    | Création des dossiers sous `\\XTS-417\Partage_individuel` |
| 3 | Mappage des lecteurs réseau           | `C:\Logs\Script3-MappageLecteurs.log`     | Application/test du mapping I/J/K (en complément de la GPO) |
| 4 | *(à compléter selon votre 4e script)* | `C:\Logs\Script4-<Nom>.log`               | *(à préciser)*                                            |
...
```powershell
Get-Content "C:\Logs\Script2-CreationDossiers.log" -Tail 20
```
...
```powershell
Select-String -Path "C:\Logs\Script2-CreationDossiers.log" -Pattern "\[ERROR\]" | Measure-Object
```
