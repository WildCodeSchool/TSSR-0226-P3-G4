...
* **[Guide d'Installation (`Install.md`)](./Install.md)** : Guide pas-à-pas pour la configuration des interfaces, l'initialisation du LAN et le déploiement du Trunk VLAN.
* **[Guide d'Utilisation du Filtrage (`User_guide.md`)](./User_guide.md)** : Manuel d'exploitation de la politique Zero Trust, règles par défaut et gestion des alias pour le cloisonnement des départements.
* **[Procédure de Fusion P2P (`Fusion.md`)](./Fusion.md)** : Protocole de raccordement et d'interconnexion sécurisée par clé partagée (Shared Key) avec notre partenaire Pharmgreen via OpenVPN.
* **[Foire Aux Questions (`FAQ.md`)](./FAQ.md)** : Réponses aux incidents fréquents, explications sur la logique des zones passives (BACKUP, WEB-INT) et l'absence de certains DHCP.
