...
- Côté équipements à superviser : les configurer pour qu'ils envoient leurs journaux vers l'adresse IP du serveur Syslog (souvent une simple ligne de configuration indiquant l'adresse du collecteur).
