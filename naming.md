...
Le chemin complet pour l'utilisateur qui est dans le service communication externe du département communication serait donc : `**XTech.green -> PRS -> A/U/O -> D1 -> s1**`  
